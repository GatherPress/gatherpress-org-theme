...
<h1 class="wp-block-heading has-text-align-center has-base-color has-text-color" style="font-weight:800"><?php esc_html_e( 'Discover Events', 'gatherpress-org-theme' ); ?></h1>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","style":{"spacing":{"margin":{"top":"var:preset|spacing|md"}}},"textColor":"base","fontSize":"md"} -->
<p class="has-text-align-center has-base-color has-text-color has-md-font-size" style="margin-top:var(--wp--preset--spacing--md)"><?php esc_html_e( 'Find and join events in your community', 'gatherpress-org-theme' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button"><a class="wp-block-button__link has-base-color has-accent-background-color has-text-color has-background wp-element-button" href="/events/" style="border-radius:8px;font-weight:600"><?php esc_html_e( 'Browse Events', 'gatherpress-org-theme' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover -->
