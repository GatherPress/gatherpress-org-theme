 ...
 * Slug: gatherpress-org-theme/upcoming-events-grid
...
<div class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--3-xl);padding-bottom:var(--wp--preset--spacing--3-xl)"><!-- wp:heading {"textAlign":"center","anchor":"upcoming-events","style":{"spacing":{"margin":{"bottom":"var:preset|spacing|2-xl"}}},"textColor":"accent"} -->
<h2 class="wp-block-heading has-text-align-center has-accent-color has-text-color" id="upcoming-events" style="margin-bottom:var(--wp--preset--spacing--2-xl)"><?php esc_html_e( 'Upcoming Events', 'gatherpress-org-theme' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:query {"queryId":10,"query":{"perPage":5,"pages":0,"offset":0,"postType":"gatherpress_event","gatherpress_event_query":"upcoming","include_unfinished":1,"order":"asc","orderBy":"datetime","inherit":false},"namespace":"gatherpress-event-query","className":"gatherpress-event-query"} -->
...
<p class="has-base-font-size" style="font-weight:600"><a href="/events/"><?php esc_html_e( 'View All Events', 'gatherpress-org-theme' ); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
